...
{
    public class AssignedToCancelledCommand : StateCommandBase
    {
        public AssignedToCancelledCommand(WorkOrder workOrder, Employee currentUser) : base(workOrder, currentUser)
        {
        }
